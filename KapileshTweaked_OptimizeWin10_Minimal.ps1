...
# Disable Location Tracking (Disables Find My Device)
...
<# Disable Cortana (Credits: https://github.com/ChrisTitusTech/win10script/blob/master/minimal.ps1)
...
<# Enable Cortana (Credits: https://github.com/ChrisTitusTech/win10script/blob/master/minimal.ps1)
